                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            @foreach($photoLibrary as $image)
                                <div class="col-6 col-sm-4 @if($data['homeSetting']->quantity == 6) col-md-2 @elseif($data['homeSetting']->quantity == 5) col-md-design-2 @elseif($data['homeSetting']->quantity == 4) col-md-3 @elseif($data['homeSetting']->quantity == 3) col-md-4 @elseif($data['homeSetting']->quantity == 2) col-md-6 @else col-md-2 @endif">
                                    <a href="{{ $image->link }}" class="mb-4">
                                        <img loading="lazy" src="{{ $admin_url . $image->url }}" class="w-100" alt="{{ $data['homeSetting']->description }}" style="{{ $data['homeSetting']->css }}"/>
                                    </a>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="container">
                        <div class="item_frame_background">
                            <div class="row">
                                ...
                                @if(!empty(json_decode($data['homeSetting']->images)[0]->{'url'}))
                            ...
                            @foreach( $data['homeSetting']->services as $itemService)
                                <div class="col-6 col-md-3 col-md-design-2 service-product">
                                    <article>
                                        ...
                                        @else
                                            <span class="img" style="@if($data['homeSetting']->item_type == \App\Modules\Home\Models\HomeSetting::ROUND_CORNER_SERVICE_TYPE) border-radius: 50% @endif">
                                                <img loading="lazy" src="{{$admin_url.$itemService->image}}" alt="{{$itemService->name}}" />
                                            </span>
                                        @endif
                                        <div>
                                        ...
                                        <p><i>{!! $itemService->description !!}</i></p>
                                        <div>
                                            {!! $itemService->content !!}
                                        </div>
                                    </article>
