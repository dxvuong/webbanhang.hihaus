...
<head>
	...
	<link href="{{asset('public/css/vuong.css?v=1.0.5')}}" rel="stylesheet" type="text/css">
...
<div class="div-footer">
	@php
		use App\Modules\Home\Models\SettingModel;
		$footer = HomeSetting::where('title', 'Chân trang')->first();
		$footerLink = SettingModel::where('company_name', 'Chân trang landing page')->first();
	@endphp
	<div class="container-fuild">
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="div-footer-2">
					@if($footerLink != null && $footerLink->facebook != null)
						<a class="elementor-icon elementor-social-icon elementor-social-icon-facebook elementor-repeater-item-24bec6c" href="{{$footerLink->facebook}}" target="_blank">
							<span class="elementor-grid-item elementor-grid-item-facebook">
								<svg class="e-font-icon-svg e-fab-facebook" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg>
							</span>
						</a>
					@endif
					@if($footerLink != null && $footerLink->twitter != null)
						<span class="elementor-grid-item elementor-grid-item-twitter">
							<a class="elementor-icon elementor-social-icon elementor-social-icon-twitter elementor-repeater-item-f2de2b3" href="{{$footerLink->twitter}}" target="_blank">
					...
					@endif
					@if($footerLink != null && $footerLink->youtube != null)
						<span class="elementor-grid-item elementor-grid-item-youtube">
							<a class="elementor-icon elementor-social-icon elementor-social-icon-youtube elementor-repeater-item-311a33c" href="{{$footerLink->youtube}}" target="_blank">
								<svg class="e-font-icon-svg e-fab-youtube" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path></svg>
							</a>
						</span>
					@endif
					@if($footerLink != null && $footerLink->linkedin != null)
						<span class="elementor-grid-item elementor-grid-item-instagram">
							<a class="elementor-icon elementor-social-icon elementor-social-icon-instagram elementor-repeater-item-a79ec7f" href="{{$footerLink->linkedin}}" target="_blank">
			...
			<div class="col-md-12">
				<div class="div-footer-3">
					{!!$footer!=null?$footer->description:''!!}
				</div>
			</div>
			<div class="col-md-12">
