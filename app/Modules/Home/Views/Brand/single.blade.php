                ...
                <div class="row">
                    <div class="col-md-9">
                        <section class="details">
                            ...
                            <div class="content">
                                <p><strong><i>{{$brand->description}}</i></strong></p>
                                @php
                            ...
                            <div class="meta meta2">
                                ...
                                <ul class="social-share">
                                    <li class="">
                                        <a aria-label="Facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ url($brand->slug) }}" class="facebook" rel="nofollow noopener noreferrer">
                                            <i class="fa-brands fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a aria-label="Twitter" target="_blank" href="https://twitter.com/intent/tweet?status='{{ url($brand->slug) }}" class="twitter" rel="nofollow noopener noreferrer">
                                            <i class="fa-brands fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a aria-label="Pinterest" target="_blank" href="https://pinterest.com/pin/create/button?url={{ url($brand->slug) }}" class="pinterest" rel="nofollow noopener noreferrer">
                            ...
                            <div class="comment" id="comment">
                                ...
                                <div class="cmt_list_box">
                                    <ul>
                                        @php($comments = \App\Modules\Comment\Models\Comment::whereNull('parent')->where('status', '=', 1)->where('blog_id', '=', $brand->id)->orderBy('created_at', 'ASC')->paginate(10))
                                        ...
                                        @if(!empty($comments))
                                            @foreach($comments as $cmt)
                                                <li>
                                                    ...
                                                    @php($comments_child = \App\Modules\Comment\Models\Comment::where('parent', '=', $cmt->id)->where('status', '=', 1)->where('blog_id', '=', $brand->id)->orderBy('created_at', 'ASC')->paginate(10))
                                                    ...
                                                    <form method="POST" action="{{route('comment.blog.child')}}" accept-charset="UTF-8" id="cmt_reply" enctype="multipart/form-data">
                                                        ...
                                                        <div class="cmt_form_bottom">
                                                            ...
                                                            <div class="cmt_submit">
                                                                ...
                                                                <input type="hidden" value="{{ url($brand->slug) }}" name="product_slug" />
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-md-3 single_product">
                        <sidebar class="sidebar">
                            <div class="meta">
                                <div class="author">
                                    @if(!empty($brand->author))
                                        <i class="fa fa-user-circle-o" aria-hidden="true"></i> {{\App\Modules\Blog\Models\User::where('user_id', '=', $brand->author)->first()->user_name}}
                                    @endif
                                </div>
