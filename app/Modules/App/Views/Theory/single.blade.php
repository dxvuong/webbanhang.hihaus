                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                @endif
                                <li class="breadcrumb-item active" aria-current="page">{{$theory->name}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-9">
                        <section class="details">
                            ...
                            <div class="content">
                                <p><strong><i>{{$theory->description}}</i></strong></p>
                                @php
                                    $content = $theory->content;
                                    $content = str_replace('app/images/theory', Config::get('app.PATH_ADMIN').'app/images/theory', $content);
                                    echo $content;
                                @endphp
                            </div>
                            ...
                            <div class="meta meta2">
                                ...
                                <ul class="social-share">
                                    <li class="">
                                        <a aria-label="Facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ $theory->generateURL() }}" class="facebook" rel="nofollow noopener noreferrer">
                                            <i class="fa-brands fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a aria-label="Twitter" target="_blank" href="https://twitter.com/intent/tweet?status='{{ $theory->generateURL() }}" class="twitter" rel="nofollow noopener noreferrer">
                                            <i class="fa-brands fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a aria-label="Pinterest" target="_blank" href="https://pinterest.com/pin/create/button?url={{ $theory->generateURL() }}" class="pinterest" rel="nofollow noopener noreferrer">
                            ...
                            <div class="comment d-none" id="comment">
                                <h2>Bình luận</h2>

                                <div class="cmt_list_box">
                                    <ul>
                                        @php($comments = \App\Modules\Comment\Models\Comment::whereNull('parent')->where('status', '=', 1)->where('blog_id', '=', $theory->id)->orderBy('created_at', 'ASC')->paginate(10))
                                        ...
                                        @if(!empty($comments))
                                            @foreach($comments as $cmt)
                                                <li>
                                                    ...
                                                    @php($comments_child = \App\Modules\Comment\Models\Comment::where('parent', '=', $cmt->id)->where('status', '=', 1)->where('blog_id', '=', $theory->id)->orderBy('created_at', 'ASC')->paginate(10))
                                                    ...
                                                    <form method="POST" action="{{route('comment.blog.child')}}" accept-charset="UTF-8" id="cmt_reply" enctype="multipart/form-data">
                                                        ...
                                                        <div class="cmt_form_bottom">
                                                            ...
                                                            <div class="cmt_submit">
                                                                ...
                                                                <input type="hidden" value="{{$theory->id}}" name="product_id" />
                                                                <input type="hidden" value="" name="parent_id" class="parent_id"/>
                                                                <input type="hidden" value="{{ $theory->generateURL() }}" name="product_slug" />
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-md-3 single_product">
                        <sidebar class="sidebar">
                            <div class="meta">
                                <div class="author">
                                    @if(!empty($theory->author))
                                        <i class="fa fa-user-circle-o" aria-hidden="true"></i> {{\App\Modules\Blog\Models\User::where('user_id', '=', $theory->author)->first()->user_name}}
                                    @endif
                                </div>
