                        ...
                        <section class="details">
                            ...
                            <div class="meta meta2">
                                ...
                                <ul class="social-share">
                                    <li class="">
                                        <a aria-label="Facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ $blog->generateURL() }}" class="facebook" rel="nofollow noopener noreferrer">
                                            <i class="fa-brands fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a aria-label="Twitter" target="_blank" href="https://twitter.com/intent/tweet?status='{{ $blog->generateURL() }}" class="twitter" rel="nofollow noopener noreferrer">
                                            <i class="fa-brands fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a aria-label="Pinterest" target="_blank" href="https://pinterest.com/pin/create/button?url={{ $blog->generateURL() }}" class="pinterest" rel="nofollow noopener noreferrer">
                            ...
                            <div class="comment" id="comment">
                                ...
                                <div class="cmt_list_box">
                                    <ul>
                                        @php($comments = \App\Modules\Comment\Models\Comment::whereNull('parent')->where('status', '=', 1)->where('blog_id', '=', $blog->id)->orderBy('created_at', 'ASC')->paginate(10))
                                        ...
                                        @if(!empty($comments))
                                            @foreach($comments as $cmt)
                                                <li>
                                                    ...
                                                    @php($comments_child = \App\Modules\Comment\Models\Comment::where('parent', '=', $cmt->id)->where('status', '=', 1)->where('blog_id', '=', $blog->id)->orderBy('created_at', 'ASC')->paginate(10))
                                                    ...
                                                    <form method="POST" action="{{route('comment.blog.child')}}" accept-charset="UTF-8" id="cmt_reply" enctype="multipart/form-data">
                                                        ...
                                                        <div class="cmt_form_bottom">
                                                            ...
                                                            <div class="cmt_submit">
                                                                ...
                                                                <input type="hidden" value="{{ $blog->generateURL() }}" name="product_slug" />
                                                            </div>
                                                        </div>
